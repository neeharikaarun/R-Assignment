...
k <- read.csv("C:/Users/dell/Desktop/DATA_SET/iris.csv")
k
k1 <- k[,1:2]
k1
...
plot(k1[km$cluster ==1,],main="NEEHARIKA A[1BM16CS056]",col="red",xlim=c(min(k1[,1]),max(k1[,1])),ylim=c(min(k1[,2]),max(k1[,2])))
